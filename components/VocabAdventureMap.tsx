    ...
    <div className="flex flex-col items-center min-h-[80vh] p-4 font-sans relative">
      ...
      <div className="text-center mt-12 mb-8">
        ...
        <div className="flex gap-4 justify-center">
            <div className="bg-white px-6 py-2 rounded-full shadow-md border-4 border-emerald-100 flex items-center">
              <span className="text-xl font-bold text-gray-600">已精熟單字: </span>
              <span className="text-3xl font-black text-emerald-600 ml-2">{masteredCount}</span>
            </div>
            <div className="bg-white px-6 py-2 rounded-full shadow-md border-4 border-amber-100 flex items-center">
              <span className="text-xl font-bold text-gray-600">擁有金幣: </span>
              <span className="text-3xl font-black text-amber-500 ml-2">{userData.coins}</span>
            </div>
        </div>
      </div>
      ...
      <div className="flex w-full max-w-[80rem] gap-8 mt-4">
        ...
        <div className="w-1/3 flex flex-col gap-6">
          ...
          >
            ...
            <h3 className="text-3xl font-black text-yellow-700">魔法扭蛋機</h3>
            <p className="text-lg text-yellow-600 font-bold mt-2">花費金幣抽新怪獸！</p>
          </button>
        </div>
            ...
            {Array.from({ length: TOTAL_LEVELS }).map((_, i) => {
              ...
              return (
                <button 
                  ...
                  className="border-b-8 rounded-3xl p-6 flex flex-col items-center justify-center active:border-b-0 active:translate-y-2 transition-all shadow-md group relative bg-emerald-100 border-emerald-300 hover:bg-emerald-200"
                >
                  <div className="text-5xl mb-2 group-hover:scale-110 transition-transform drop-shadow-sm">🚩</div>
                  <div className="text-2xl font-black tracking-wide text-emerald-800">第 {level} 關</div>
